 ...
 *
 */
public class CheetahCalciteConnection {
  private final String url;
  
  CheetahCalciteConnection(String url, String coordinatorUrl) {
    this.url = Preconditions.checkNotNull(url);
    Preconditions.checkNotNull(coordinatorUrl);
  }
  ...
  void metadata(String dataSourceName, List<String> intervals,
    ...
    final Map<String, String> requestHeaders =
        ImmutableMap.of("Content-Type", "application/json");
    final String data = metadataQuery(dataSourceName, intervals);
    if (CalcitePrepareImpl.DEBUG) {
  ...
  Set<String> tableNames() {
    ...
    final String url = this.url + "/druid/v2/datasources";
    if (CalcitePrepareImpl.DEBUG) {
